...
export default function LoginPage() {
    return (
        <div className="min-h-screen bg-[#0b0f19] flex flex-col justify-center relative overflow-hidden px-4 font-sans">
            ...
            {/* Geometric Accents */}
            <div className="absolute top-1/4 right-1/4 w-64 h-64 border border-indigo-500/5 rotate-45 pointer-events-none hidden lg:block" />
            <div className="absolute bottom-1/4 left-1/4 w-96 h-96 border border-violet-500/5 -rotate-12 pointer-events-none hidden lg:block" />
